        ...
        try :
            for item in replies:
                ...
                fcomment = comment(self.commentConfig.get_oid(),\
                                ...
                                like,message,uname,location,sex,db = self.db)
                self.__comment_data.append(fcomment)
                fcomment.writeDataBase()
