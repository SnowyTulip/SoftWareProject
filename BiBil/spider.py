...
def get_wid(pagination_str,timeStamp):
    ...
    timeStamp = 1702369678
    pagination_str = '''\\"offset\\":{\\"type\\":1,\\"direction\\":1,\\"session_id\\":\\"1743221506309241\\",\\"data\\":{}}'''
    pagination_str = "{\"offset\":\"{\\\"type\\\":1,\\\"direction\\\":1,\\\"session_id\\\":\\\"1743221506309241\\\",\\\"data\\\":{}}\"}"
    ut = {
    "oid":"747023094",
    "type":"1",
...
def read_data(response):
    ...
    for item in replies:
        ...
        # print()
    f.close()
    next_pagination_str = str({"offset":next_pagination_str}).replace("\'","\"") 
...
def read_url(pagination_str,is_first = False,FirstUrl = "") :
    ...
    if is_first:
        ...
        base_url = f"https://api.bilibili.com/x/v2/reply/wbi/main?oid=747023094&type=1&mode=3&pagination_str={quote_plus(pagination_str)}&plat=1&seek_rpid=&web_location=1315875&w_rid={w_rid}&wts={timeStamp}"
    print(f"url:{base_url}")
    print(f"pagination_str:{pagination_str}")
    print(f"w_rid:{w_rid}")
...
if __name__ == "__main__":
    ...
    first_url = "https://api.bilibili.com/x/v2/reply/wbi/main?oid=747023094&type=1&mode=3&pagination_str=%7B%22offset%22:%22%22%7D&plat=1&seek_rpid=&web_location=1315875&w_rid=0c1e6a82fae78088729181adac7014c7&wts=1702364752"
